...
def train_1D_advection_diffusion_PINN():
    ...
    for activation_name, activation_fn in activations.items():
        ...
        if activation_name == 'Tanh':
            save_path = "1D_advection_diffusion_tanh_adam2lbfgs_pinn.pth"
            complete_save_dict = {
    ...
    print("\n" + "="*120)
    print("Advection-Diffusion Equation - PINN Comprehensive Comparison Table (Basic Version, No GMM/Curriculum Learning)")
    print("="*120)
    ...
    # 7. Print Best Performance Ranking by L2 Error
    print("\n" + "="*100)
...
train_1D_advection_diffusion_PINN()