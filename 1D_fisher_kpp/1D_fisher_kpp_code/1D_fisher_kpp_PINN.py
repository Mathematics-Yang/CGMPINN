...
# 3. Adam optimizer training function
...
# 4. L-BFGS optimizer training function
...
# 5. Two-stage training (Adam→L-BFGS): global exploration + local fine-tuning
...
def train_1D_fisher_kpp_PINN():
    ...
    # generate data
    print("Generating training/testing data for the convection-diffusion equation...")
    ...
    for activation_name, activation_fn in activations.items():
        ...
        save_path = "1D_fisher_kpp_tanh_adam2lbfgs_pinn.pth"
        complete_save_dict = {
        ...
        print(f"✅ Fisher-KPP best model saved to: {save_path}")
    ...
    print("\n" + "="*120)
    print("Fisher-KPP equation PINN training comprehensive comparison table (Activation Function × Optimizer)")
    print("="*120)
