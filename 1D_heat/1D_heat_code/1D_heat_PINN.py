...
def generate_data(
    ...
    # boundary condition points: x=0 and x=1, t ∈ [0,1]
...
# 8. main function 
def train_1D_heat_PINN_with_activations_and_source_term():
    ...
    for activation_name, activation_fn in activations.items():
        ...
        if activation_name == 'Tanh':  
            # Define save path
            save_path = "1D_heat_tanh_adam2lbfgs_pinn.pth"
    ...
    print("\n" + "="*120)
    print("Comprehensive comparison table for all activation functions × optimizers (including source term heat conduction equation)")
    print("="*120)
...
train_1D_heat_PINN_with_activations_and_source_term()